...
from seel_python_sdk.pydantic.product_dimensions import ProductDimensions
from seel_python_sdk.pydantic.product_enabled_services import ProductEnabledServices
from seel_python_sdk.pydantic.product_identifiers import ProductIdentifiers
from seel_python_sdk.pydantic.product_manufacturer_warranty import ProductManufacturerWarranty
from seel_python_sdk.pydantic.product_product_attributes import ProductProductAttributes
from seel_python_sdk.pydantic.product_weight import ProductWeight
...
class Product(BaseModel):
    ...
    identifiers: typing.Optional[ProductIdentifiers] = Field(None, alias='identifiers')

    manufacturer_warranty: typing.Optional[ProductManufacturerWarranty] = Field(None, alias='manufacturer_warranty')

    dimensions: typing.Optional[ProductDimensions] = Field(None, alias='dimensions')

    weight: typing.Optional[ProductWeight] = Field(None, alias='weight')

    product_attributes: typing.Optional[ProductProductAttributes] = Field(None, alias='product_attributes')
    ...
    enabled_services: typing.Optional[ProductEnabledServices] = Field(None, alias='enabled_services')
