...
from seel_python_sdk.pydantic.merchant import Merchant

class MerchantListAllMerchantsResponse(BaseModel):
    # Current page number.
    ...
    # List of merchants.
    merchants: typing.Optional[typing.List[Merchant]] = Field(None, alias='merchants')
