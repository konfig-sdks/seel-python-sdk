...
from seel_python_sdk.pydantic.invoice import Invoice

class InvoiceListInvoicesResponse(BaseModel):
    # Current page number.
    ...
    # List of invoices.
    invoices: typing.Optional[typing.List[Invoice]] = Field(None, alias='invoices')
