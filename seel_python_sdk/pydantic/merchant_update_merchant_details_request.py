...
from seel_python_sdk.pydantic.merchant_update_merchant_details_request_seel_services import MerchantUpdateMerchantDetailsRequestSeelServices

class MerchantUpdateMerchantDetailsRequest(BaseModel):
    ...
    seel_services: typing.Optional[MerchantUpdateMerchantDetailsRequestSeelServices] = Field(None, alias='seel_services')
