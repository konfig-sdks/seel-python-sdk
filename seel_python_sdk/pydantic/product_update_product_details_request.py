...
from seel_python_sdk.pydantic.product_update_product_details_request_dimensions import ProductUpdateProductDetailsRequestDimensions
from seel_python_sdk.pydantic.product_update_product_details_request_identifiers import ProductUpdateProductDetailsRequestIdentifiers
from seel_python_sdk.pydantic.product_update_product_details_request_manufacturer_warranty import ProductUpdateProductDetailsRequestManufacturerWarranty
from seel_python_sdk.pydantic.product_update_product_details_request_product_attributes import ProductUpdateProductDetailsRequestProductAttributes
from seel_python_sdk.pydantic.product_update_product_details_request_weight import ProductUpdateProductDetailsRequestWeight

class ProductUpdateProductDetailsRequest(BaseModel):
    # Product id.
    ...
    identifiers: typing.Optional[ProductUpdateProductDetailsRequestIdentifiers] = Field(None, alias='identifiers')

    manufacturer_warranty: typing.Optional[ProductUpdateProductDetailsRequestManufacturerWarranty] = Field(None, alias='manufacturer_warranty')

    dimensions: typing.Optional[ProductUpdateProductDetailsRequestDimensions] = Field(None, alias='dimensions')

    weight: typing.Optional[ProductUpdateProductDetailsRequestWeight] = Field(None, alias='weight')

    product_attributes: typing.Optional[ProductUpdateProductDetailsRequestProductAttributes] = Field(None, alias='product_attributes')
