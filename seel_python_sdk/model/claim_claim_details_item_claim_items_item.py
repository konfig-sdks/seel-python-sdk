...
class ClaimClaimDetailsItemClaimItemsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["line_item_id", "quantity", "reason", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["line_item_id", "quantity", "reason", ], str]):
    ...
    ) -> 'ClaimClaimDetailsItemClaimItemsItem':
