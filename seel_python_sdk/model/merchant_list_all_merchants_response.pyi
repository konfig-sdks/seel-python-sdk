...
class MerchantListAllMerchantsResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["page", "page_size", "total", "merchants", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["page", "page_size", "total", "merchants", ], str]):
