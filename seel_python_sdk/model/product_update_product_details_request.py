...
class ProductUpdateProductDetailsRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def identifiers() -> typing.Type['ProductUpdateProductDetailsRequestIdentifiers']:
                return ProductUpdateProductDetailsRequestIdentifiers
        
            @staticmethod
            def manufacturer_warranty() -> typing.Type['ProductUpdateProductDetailsRequestManufacturerWarranty']:
                return ProductUpdateProductDetailsRequestManufacturerWarranty
        
            @staticmethod
            def dimensions() -> typing.Type['ProductUpdateProductDetailsRequestDimensions']:
                return ProductUpdateProductDetailsRequestDimensions
        
            @staticmethod
            def weight() -> typing.Type['ProductUpdateProductDetailsRequestWeight']:
                return ProductUpdateProductDetailsRequestWeight
        
            @staticmethod
            def product_attributes() -> typing.Type['ProductUpdateProductDetailsRequestProductAttributes']:
                return ProductUpdateProductDetailsRequestProductAttributes
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["identifiers"]) -> 'ProductUpdateProductDetailsRequestIdentifiers': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["manufacturer_warranty"]) -> 'ProductUpdateProductDetailsRequestManufacturerWarranty': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dimensions"]) -> 'ProductUpdateProductDetailsRequestDimensions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["weight"]) -> 'ProductUpdateProductDetailsRequestWeight': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["product_attributes"]) -> 'ProductUpdateProductDetailsRequestProductAttributes': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["identifiers"]) -> typing.Union['ProductUpdateProductDetailsRequestIdentifiers', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["manufacturer_warranty"]) -> typing.Union['ProductUpdateProductDetailsRequestManufacturerWarranty', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dimensions"]) -> typing.Union['ProductUpdateProductDetailsRequestDimensions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["weight"]) -> typing.Union['ProductUpdateProductDetailsRequestWeight', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["product_attributes"]) -> typing.Union['ProductUpdateProductDetailsRequestProductAttributes', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        identifiers: typing.Union['ProductUpdateProductDetailsRequestIdentifiers', schemas.Unset] = schemas.unset,
        manufacturer_warranty: typing.Union['ProductUpdateProductDetailsRequestManufacturerWarranty', schemas.Unset] = schemas.unset,
        dimensions: typing.Union['ProductUpdateProductDetailsRequestDimensions', schemas.Unset] = schemas.unset,
        weight: typing.Union['ProductUpdateProductDetailsRequestWeight', schemas.Unset] = schemas.unset,
        product_attributes: typing.Union['ProductUpdateProductDetailsRequestProductAttributes', schemas.Unset] = schemas.unset,
