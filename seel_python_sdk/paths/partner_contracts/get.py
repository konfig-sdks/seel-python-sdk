...
from seel_python_sdk.model.contract_list_contracts_response import ContractListContractsResponse as ContractListContractsResponseSchema

from seel_python_sdk.type.contract_list_contracts_response import ContractListContractsResponse

from ...api_client import Dictionary
from seel_python_sdk.pydantic.contract_list_contracts_response import ContractListContractsResponse as ContractListContractsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ContractListContractsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContractListContractsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_contracts_mapped_args(
        self,
        x_seel_api_key: str,
        ...
        if order_id is not None:
            _query_params["order_id"] = order_id
        if page is not None:
    ...
    async def _alist_contracts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{partner}/contracts',
            headers=_headers,
        )
...
class ListContractsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_contracts(
        self,
        x_seel_api_key: str,
        x_seel_api_version: str,
        partner: str,
        ...
        **kwargs,
        ...
        args = self._list_contracts_mapped_args(
        ...
        return await self._alist_contracts_oapg(
    ...
    def list_contracts(
        ...
        return self._list_contracts_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class ListContracts(BaseApi):
    ...
    async def alist_contracts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContractListContractsResponsePydantic:
        raw_response = await self.raw.alist_contracts(
            x_seel_api_key=x_seel_api_key,
            x_seel_api_version=x_seel_api_version,
            partner=partner,
            order_id=order_id,
        ...
        if validate:
            return ContractListContractsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ContractListContractsResponsePydantic, raw_response.body)
    ...
    def list_contracts(
        ...
        raw_response = self.raw.list_contracts(
            x_seel_api_key=x_seel_api_key,
            x_seel_api_version=x_seel_api_version,
            partner=partner,
            order_id=order_id,
