...
from seel_python_sdk.model.invoice_list_invoices_response import InvoiceListInvoicesResponse as InvoiceListInvoicesResponseSchema

from seel_python_sdk.type.invoice_list_invoices_response import InvoiceListInvoicesResponse

from ...api_client import Dictionary
from seel_python_sdk.pydantic.invoice_list_invoices_response import InvoiceListInvoicesResponse as InvoiceListInvoicesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = InvoiceListInvoicesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: InvoiceListInvoicesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_invoices_mapped_args(
        self,
        x_seel_api_key: str,
    ...
    async def _alist_invoices_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{partner}/invoices',
            headers=_headers,
        )
...
class ListInvoicesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_invoices(
        self,
        x_seel_api_key: str,
        x_seel_api_version: str,
        partner: str,
        ...
        **kwargs,
        ...
        args = self._list_invoices_mapped_args(
        ...
        return await self._alist_invoices_oapg(
...
class ListInvoices(BaseApi):
    ...
    async def alist_invoices(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InvoiceListInvoicesResponsePydantic:
        raw_response = await self.raw.alist_invoices(
            x_seel_api_key=x_seel_api_key,
            x_seel_api_version=x_seel_api_version,
            partner=partner,
            page=page,
        ...
        if validate:
            return InvoiceListInvoicesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(InvoiceListInvoicesResponsePydantic, raw_response.body)
    ...
    def list_invoices(
        ...
        raw_response = self.raw.list_invoices(
            x_seel_api_key=x_seel_api_key,
            x_seel_api_version=x_seel_api_version,
            partner=partner,
            page=page,
