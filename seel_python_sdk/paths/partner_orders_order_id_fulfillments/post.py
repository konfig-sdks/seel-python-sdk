...
from seel_python_sdk.model.fulfillment_line_items import FulfillmentLineItems as FulfillmentLineItemsSchema
...
from seel_python_sdk.pydantic.fulfillment_line_items import FulfillmentLineItems as FulfillmentLineItemsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FulfillmentSchema


request_body_fulfillment = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_fulfillment_mapped_args(
        self,
        fulfillment_id: str,
        created_ts: datetime,
        updated_ts: datetime,
        ...
        if fulfillment_id is not None:
            _body["fulfillment_id"] = fulfillment_id
    ...
    async def _acreate_new_fulfillment_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_fulfillment.serialize(body, content_type)
    ...
    def _create_new_fulfillment_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CreateNewFulfillmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_fulfillment(
        self,
        fulfillment_id: str,
        created_ts: datetime,
        updated_ts: datetime,
        ...
        **kwargs,
        ...
        args = self._create_new_fulfillment_mapped_args(
        ...
        return await self._acreate_new_fulfillment_oapg(
            body=args.body,
    ...
    def create_new_fulfillment(
        ...
        return self._create_new_fulfillment_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreateNewFulfillment(BaseApi):
    ...
    async def acreate_new_fulfillment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_fulfillment(
            fulfillment_id=fulfillment_id,
            created_ts=created_ts,
            updated_ts=updated_ts,
            tracking_number=tracking_number,
    ...
    def create_new_fulfillment(
        ...
        raw_response = self.raw.create_new_fulfillment(
            fulfillment_id=fulfillment_id,
            created_ts=created_ts,
            updated_ts=updated_ts,
            tracking_number=tracking_number,
