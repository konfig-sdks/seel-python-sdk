...
from seel_python_sdk.model.quote_generate_quote_request import QuoteGenerateQuoteRequest as QuoteGenerateQuoteRequestSchema
from seel_python_sdk.model.quote import Quote as QuoteSchema
from seel_python_sdk.model.customer import Customer as CustomerSchema

from seel_python_sdk.type.customer import Customer
from seel_python_sdk.type.quote_generate_quote_request import QuoteGenerateQuoteRequest
from seel_python_sdk.type.item import Item
from seel_python_sdk.type.quote import Quote
...
from seel_python_sdk.pydantic.quote_generate_quote_request import QuoteGenerateQuoteRequest as QuoteGenerateQuoteRequestPydantic
from seel_python_sdk.pydantic.quote import Quote as QuotePydantic
...
# body param
SchemaForRequestBodyApplicationJson = QuoteGenerateQuoteRequestSchema


request_body_quote_generate_quote_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = QuoteSchema
...
class BaseApi(api_client.Api):
    ...
    def _generate_quote_mapped_args(
        self,
        session_id: str,
        type: str,
    ...
    async def _agenerate_quote_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{partner}/quotes',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_quote_generate_quote_request.serialize(body, content_type)
...
class GenerateQuoteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_quote(
        self,
        session_id: str,
        type: str,
        line_items: typing.List[Item],
        ...
        **kwargs,
        ...
        args = self._generate_quote_mapped_args(
        ...
        return await self._agenerate_quote_oapg(
            body=args.body,
    ...
    def generate_quote(
        ...
        return self._generate_quote_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class GenerateQuote(BaseApi):
    ...
    async def agenerate_quote(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_quote(
            session_id=session_id,
            type=type,
            line_items=line_items,
            shipping_address=shipping_address,
        ...
        if validate:
            return QuotePydantic(**raw_response.body)
        return api_client.construct_model_instance(QuotePydantic, raw_response.body)
    ...
    def generate_quote(
        ...
        raw_response = self.raw.generate_quote(
            session_id=session_id,
            type=type,
            line_items=line_items,
            shipping_address=shipping_address,
