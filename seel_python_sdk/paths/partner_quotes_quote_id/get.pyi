...
# Path params
QuoteIdSchema = schemas.StrSchema
PartnerSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'quote_id': typing.Union[QuoteIdSchema, str, ],
...
request_path_quote_id = api_client.PathParameter(
    name="quote_id",
    style=api_client.ParameterStyle.SIMPLE,
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{partner}/quotes/{quote_id}',
            headers=_headers,
        )
