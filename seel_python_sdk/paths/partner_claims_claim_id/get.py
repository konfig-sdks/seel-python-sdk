...
from seel_python_sdk.model.claim import Claim as ClaimSchema

from seel_python_sdk.type.claim import Claim

from ...api_client import Dictionary
from seel_python_sdk.pydantic.claim import Claim as ClaimPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'claim_id': typing.Union[ClaimIdSchema, str, ],
...
SchemaFor200ResponseBodyApplicationJson = ClaimSchema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{partner}/claims/{claim_id}',
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return ClaimPydantic(**raw_response.body)
        return api_client.construct_model_instance(ClaimPydantic, raw_response.body)
