...
from seel_python_sdk.model.contract import Contract as ContractSchema

from seel_python_sdk.type.contract import Contract

from ...api_client import Dictionary
from seel_python_sdk.pydantic.contract import Contract as ContractPydantic
...
SchemaFor200ResponseBodyApplicationJson = ContractSchema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{partner}/contracts/{contract_id}',
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return ContractPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContractPydantic, raw_response.body)
