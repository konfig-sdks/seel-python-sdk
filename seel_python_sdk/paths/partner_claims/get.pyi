...
from seel_python_sdk.model.claim_get_all_claims_response import ClaimGetAllClaimsResponse as ClaimGetAllClaimsResponseSchema

from seel_python_sdk.type.claim_get_all_claims_response import ClaimGetAllClaimsResponse

from ...api_client import Dictionary
from seel_python_sdk.pydantic.claim_get_all_claims_response import ClaimGetAllClaimsResponse as ClaimGetAllClaimsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ClaimGetAllClaimsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ClaimGetAllClaimsResponse
...
class GetAllClaims(BaseApi):
    ...
    async def aget_all_claims(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ClaimGetAllClaimsResponsePydantic:
        ...
        if validate:
            return ClaimGetAllClaimsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ClaimGetAllClaimsResponsePydantic, raw_response.body)
